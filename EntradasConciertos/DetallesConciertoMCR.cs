...
namespace EntradasConciertos
{
    public partial class DetallesConciertoMCR : Form
    {
        ...
        private void DetallesConciertoMCR_FormClosed(object sender, FormClosedEventArgs e)
        {
            CerrarAplicacion();
        }
        ...
        {
            new VentanaPago(1, (int)numEntradas.Value, (int)(numEntradas.Value * concierto.precioEntrada)).Show();
            this.Close();
        }
